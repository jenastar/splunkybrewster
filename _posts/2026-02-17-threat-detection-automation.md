...
<video controls width="100%" preload="metadata">
  <source src="/assets/media/threat-detection-demo.mp4" type="video/mp4">
</video>
...
![Splunk's Benchmarks](/assets/media/splunks-bench.png)

This project's Benchmarks:

![AskSplunk Benchmarks](/assets/media/as-bench.png)
