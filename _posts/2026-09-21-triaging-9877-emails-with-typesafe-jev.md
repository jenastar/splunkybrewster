...
**Never chain a destructive step after an unverified one.** A bulk-unsubscribe script tried to copy flagged spam to a Bulk folder via IMAP, hit a rate limit, and proceeded to delete the originals anyway without checking the copy succeeded. Lesson: check success before the next irreversible step, always.
